...
def nexcrc_metric_recorder(config, data_streams, domainwise_dataloaders, 
    ...
    row_items = ['realtime_acc', 'budgets', 'realtime_cov', 'pretrained_cov'] + domain_names
    ...
    batch_level_columns = ["batch_index", 
                           ...
                           "before_training_pseudo_loss_sum",
                            ...
                            "before_training_oracle_loss_avg",
                           "before_training_pseudo_loss_avg",

                           "before_training_oracle_loss_per_sample",
                           "before_training_pseudo_loss_per_sample",
    ...
    for data_stream_name in data_stream_names:
        ...
        for idx, batch in enumerate(data_streams[data_stream_name]):
            ...
            if batch.domain_name != source_domain_name:
                ...
                before_training_oracle_loss_sum, before_training_pseudo_loss_sum = atta_obj.get_before_training_loss()
                before_training_oracle_loss_avg = before_training_oracle_loss_sum / atta_obj.oracle_labeled_storage.num_elem()
                before_training_pseudo_loss_avg = before_training_pseudo_loss_sum / atta_obj.pseudo_labeled_storage.num_elem()


                before_training_oracle_loss_per_sample = atta_obj.before_training_oracle_loss_per_sample
                before_training_pseudo_loss_per_sample = atta_obj.before_training_pseudo_loss_per_sample
                ...
                # append 8 types of loss
                batch_level_new_dict['before_training_oracle_loss_sum'] = before_training_oracle_loss_sum
                batch_level_new_dict['before_training_pseudo_loss_sum'] = before_training_pseudo_loss_sum

                batch_level_new_dict['before_training_oracle_loss_avg'] = before_training_oracle_loss_avg
                batch_level_new_dict['before_training_pseudo_loss_avg'] = before_training_pseudo_loss_avg

                batch_level_new_dict['before_training_oracle_loss_per_sample'] = before_training_oracle_loss_per_sample
                batch_level_new_dict['before_training_pseudo_loss_per_sample'] = before_training_pseudo_loss_per_sample
                ...
                realtime_covered += ( batch_level_new_dict['realtime_cp_cov'] * len(batch.dataloader.dataset) )
                pretrained_covered += ( batch_level_new_dict['pretrained_cp_cov'] * len(batch.dataloader.dataset) )
            ...
            if idx != ( len(data_streams[data_stream_name]) - 1 ): # test if not the last batch
                ...
                if (next_domain_name != test_domain_name) and (test_domain_name != source_domain_name): 
                    if data_stream_name == "domainwise":
                        ...
                        continue_result_df.loc["realtime_cov", test_domain_name] = realtime_covered / num_samples
                        continue_result_df.loc["pretrained_cov", test_domain_name] = pretrained_covered / num_samples
